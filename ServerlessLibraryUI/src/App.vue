      ...
      <div class="headerbar">
         <div class="azurelogo" >
            <a href="https://azure.microsoft.com/"  target="_blank" title="Microsoft Azure" >
               ...
               <svg aria-hidden="true" role="presentation" class="azurelogo">
                  <use xlink:href="#svg-msazure-logo"></use>
               </svg>
            </a>
         </div>
            ...
            <a href="https://github.com/Azure/ServerlessLibrary"  target="_blank" title="How to Contribute" >
               ...
               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 12" class="contributelink" >
                  ...
                  <g transform="translate(-1337 -14)">
                     <path class="contributelink" d="M4.279,8.416l6.873-6.85V5H12V0H7V.858h3.462L3.627,7.7Z" transform="translate(1337 14)"/>
                     <path  d="M11.137,11.169H.865V.881H5V0H0V12H12V7h-.863Z" transform="translate(1337 14)"/>
                  </g>
               </svg>
            </a>
         </div>
